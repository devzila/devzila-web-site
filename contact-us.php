      	...
      	<div>
      		...
      		<table class="table-style pt-4">
				<tbody>
					...
					<tr>
						<td class="half"><input class="input-styling" maxlength="80" name="enterdigest" type="text" placeholder="Enter the Captcha" required data-error="Please complete the Captcha"></td>
