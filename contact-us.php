      	...
      	<div>
      		...
      		<table class="table-style pt-4">
				<tbody>
					...
					<tr class="pull-right">
						<td colspan="2"><a href="index.php"><button type="submit" onclick="function()" class="btn btn-danger btn-md mr-2">Submit</button></a><button type="reset" class="btn btn-secondary btn-md">Reset</button></td>
					</tr>
				</tbody>
			</table>
		</form>
